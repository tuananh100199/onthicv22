                ...
                <div className='d-flex justify-content-center align-items-center'>
                    ...
                    {isActiveZalo?
                        <a href={`https://zalo.me/${zaloId}`} rel="noreferrer" target="_blank" className='home-contact-button'>
                            ...
                            {/* <img src='/img/logo-zalo.png' alt="zalo" style={{width:24,height:24}} /> */}
                            <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 460.1 436.6" width="24" height="24" style={{marginRight:8}}>
                                ...
                                <path className="st0" style={{fill:'#199D76'}} d="M235.7 196.3c-.1-14.1 7.6-22.6 18.5-22 4.7.2 9.1 2.5 11.9 6.4 5.6 7.5 5.6 20.1 0 27.7-5.4 7.2-15.7 8.7-23 3.3-1.2-.9-2.3-2-3.3-3.3-2.5-3.5-3.9-7.7-4.1-12.1zM365.5 194.5c0-12.4 7.6-20.7 18.4-20.1 4.7.1 9.1 2.5 11.9 6.3 5.7 7.6 5.7 20.5-.1 28-5.6 7.1-16 8.3-23.1 2.7-1.1-.8-2-1.8-2.8-2.9-3-4.1-4.4-9-4.3-14z"/>
                                <path className="st3" style={{fill:'none',stroke:'#0180c7',strokeWidth:2,strokeWmiterlimit:10}} d="M66 1h328.1c35.9 0 65 29.1 65 65v303c0 35.9-29.1 65-65 65H66c-35.9 0-65-29.1-65-65V66C1 30.1 30.1 1 66 1z"/>
                            </svg>
                            <span>Zalo</span>
                        </a>
                    :null}
