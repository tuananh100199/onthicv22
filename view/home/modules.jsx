...
export const modules = [_init, fwComment, fwDepartment, fwHome, fwMenu, fwNotification, fwUser, fwCandidate, fwCertificate, fwChangeLecturer, fwCourse, fwCourseType, fwDivision, fwContact, fwNews, fwSubscribe];