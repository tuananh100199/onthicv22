...
export const modules = [_init, fwComment, fwHome, fwMenu, fwNotification, fwUser, fwCandidate, fwCertificate, fwChangeLecturer, fwCourse, fwCourseType, fwDivision, fwContact, fwNews, fwSubscribe];