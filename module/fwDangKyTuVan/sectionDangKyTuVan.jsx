...
class SectionDangKyTuVan extends React.Component {
    ...
    render() {
        ...
        return [
            <div key={0} className='home-dangkytuvan d-flex flex-column align-items-start justify-content-end'>
                <div ref={this.background} className='parallax_background parallax-window' data-parallax='scroll' data-image-src={dangkytuvan} data-speed='0.8' />
            ...
            <div key={1} className='dangkytuvan'>
                <div className='container'>
                    <div className='row'>
                        <div className='col-lg-6'>
                            <div className='dangkytuvan_form_container'>
                                <div className='dangkytuvan_form_title'>Liên hệ</div>
                                <form className='dangkytuvan_form' id='dangkytuvan_form' onSubmit={this.sendMessage}>
                                    <div className='d-flex flex-row align-items-start justify-content-between flex-wrap'>
                                        <input type='text' className='dangkytuvan_input' ref={this.name} placeholder='Tên' />
                                        <input type='email' className='dangkytuvan_input' ref={this.email} placeholder='Email' />
                                        <input type='text' className='dangkytuvan_input w-100' ref={this.subject} placeholder='Chủ đề' />
                                        <textarea name='message' className='dangkytuvan_input w-100' ref={this.message} cols='30' rows='10' placeholder='Nội dung' />
                                    </div>
                                    <button className='button button_1 dangkytuvan_button trans_200'>gửi tin nhắn</button>
                                </form>
                            </div>
                        </div>
                        <div className='col-lg-5 offset-lg-1 dangkytuvan_col'>
                            <div className='dangkytuvan_content'>
                                <div className='dangkytuvan_content_title ftco-animate'>Thông tin liên hệ</div>
                                {this.props.address && this.props.address.list && this.props.address.list.length > 0 ?
                                    this.props.address.list.map((item, index) => (
                                        <div className='dangkytuvan_info ftco-animate' key={index}>
                                            <ul>
                                ...
                                <div className='dangkytuvan_social ftco-animate'>
...
const mapActionsToProps = { createDangKyTuVan, getAllAddressByUser };
