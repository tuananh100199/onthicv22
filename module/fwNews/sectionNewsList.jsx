            ...
            elements = userPage.list.map((item, index) => {
                ...
                return (
                    <div className="blog_post" key={index}>
                        <div classclass="blog_post_image"><img src={item && item.image ? item.image : ''} alt="" /></div>
                        ...
                        <div className="blog_post_title"><a href={link}>{item && item.title ? item.title : ''}</a></div>
                        ...
                        <div className="blog_post_button text-center"><div className="button button_1 ml-auto mr-auto"><a href="#">Xem thêm</a></div></div>
                    </div>
                );
            });
        }
