...
import { ajaxGetFormInPage, ajaxGetForm, updateForm } from './redux.jsx';
...
class SectionApplyForm extends React.Component {
    ...
    render() {
        const canUpdate = this.props.currentPermission && this.props.currentPermission.contains('user-form:write');
        return (
            <div className='tile'>
                        ...
                        <div>
                            ...
                            <div className='row'>
                                ...
                                <div className='col-12 text-right'>
                                    <Link to={'/user/user-form/edit/' + this.state.selectedForm.value} className='text-primary'><i>Chỉnh sửa form</i></Link>
                                </div>
                            </div>
                        </div>
                    ) : ''}
