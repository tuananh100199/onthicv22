module.exports = app => {
    ...
    app.post('/api/form', app.permission.check('user-form:write'), (req, res) => app.model.form.create(req.body.data, (error, item) => {
        res.send({ error, item })
    }));

    app.put('/api/form', app.permission.check('user-form:write'), (req, res) => {
    ...
    app.delete('/api/form', app.permission.check('user-form:write'), (req, res) => app.model.form.delete(req.body._id, error => res.send({ error })));
    ...
    app.post('/api/question/:_id', app.permission.check('user-form:write'), (req, res) => {
    ...
    app.put('/api/question', app.permission.check('user-form:write'), (req, res) => {
    ...
    app.put('/api/question/swap', app.permission.check('user-form:write'), (req, res) => {
    ...
    app.delete('/api/question', app.permission.check('user-form:write'), (req, res) => {
