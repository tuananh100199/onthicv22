module.exports = app => {
    ...
    // Hook upload images ---------------------------------------------------------------------------------------------------------------------------
    app.createFolder(app.path.join(app.publicPath, '/img/hang-gplx1'));
    app.createFolder(app.path.join(app.publicPath, '/img/hang-gplx2'));
    app.createFolder(app.path.join(app.publicPath, '/img/hang-gplx3'));
