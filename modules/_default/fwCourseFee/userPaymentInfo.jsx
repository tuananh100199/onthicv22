        ...
        const table = renderTable({
            ...
            renderRow: (item, index) => (
                <tr key={index}>
                    ...
                    <TableCell type='text' content={'Học phí khóa B1'} />
                    <TableCell type='text' style={{ whiteSpace: 'nowrap' }} content={''} />
                    <TableCell type='text' style={{ whiteSpace: 'nowrap' }} content={hocPhiConLai} />
                    <TableCell type='text' content={T.dateToText(this.state.ngayHetHanNopHocPhi, 'dd/mm/yyyy')} />
