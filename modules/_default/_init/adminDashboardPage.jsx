        ...
        return this.renderPage({
            ...
            content: (
                <div className='row'>
                    ...
                    <DashboardIcon iconBackgroundColor='coral' icon='fa-user-secret' title='Giáo viên' value={numberOfLecturer} link='/user/teacher' readOnly={permission.settings} />
                    <DashboardIcon iconBackgroundColor='#900' icon='fa-address-card-o' title='Giáo viên đi khóa' value={numberOfLecturer} link='/user/teacher-course' readOnly={permission.settings} />
                    <DashboardIcon iconBackgroundColor='#64b5f6' icon='fa-calendar' title='Lịch dạy' link='/user/course' readOnly={permission.settings} />
                    <DashboardIcon iconBackgroundColor='#8e24aa' icon='fa-star' title='Đánh giá giáo viên' link='/user/rating-teacher' readOnly={permission.settings} />
                </div>),
        });
    }
}
