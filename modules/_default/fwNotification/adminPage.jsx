...
class NotificationModal extends AdminModal {
    ...
    onSubmit = () => {
        ...
        if (data.type == 0) delete data.course;
    ...
    render = () => {
        const { _id, createdDate, isUserShow } = this.state;
        ...
        return this.renderModal({
            ...
            body: <>
                ...
                <div className='row'>
                    ...
                    <FormSelect className={'col-md-6 ' + (isUserShow ? '' : 'd-none')} ref={e => this.user = e} label='Học viên' data={ajaxSelectUser} readOnly={readOnly} />
                    <FormSelect className={'col-md-6 ' + (isUserShow ? 'd-none' : '')} ref={e => this.course = e} label='Khoá học' data={ajaxSelectCourse} readOnly={readOnly} />
                </div>
                            ...
                            {list.map((item, index) => (
                                <li key={index} className='notification'>
                                    ...
                                    {permission.write ?
                                        ...
                                        <a href='#' className={item.type == 0 ? 'text-warning' : 'text-success'} onClick={e => e.preventDefault() || this.modal.show(item)}>{item.title}</a>}
