    ...
    render() {
        ...
        return (
            <main className='app-content'>
                ...
                <AddAnswerModal ref={this.addModal} questions={questions} formId={item._id} readOnly={!currentPermission.contains('form:write')} />
...
const mapStateToProps = state => ({ form: state.form, question: state.reduxQuestion, answer: state.reduxAnswer, system: state.system });
const mapActionsToProps = { getForm, updateForm, getQuestionsList, getAnswerInPage, getAnswer, updateAnswer, deleteAnswer, exportRegisters };
