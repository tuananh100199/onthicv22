...
class EditCoursePage extends AdminPage {
    state = { name: '...' };
    componentDidMount() {
        T.ready('/user/lecturer', () => {
            const route = T.routeMatcher('/user/lecturer/:_id'),
    ...
    render() {
        ...
        const tabInfo = <div className='row'>
            <h3 className='tile-title' style={{ paddingLeft: 15, marginBottom: 5, width: '100%' }}>Thông tin chung</h3>
        ...
        return this.renderPage({
            ...
            breadcrumb: [<Link key={0} to='/user/lecturer'>Khóa học</Link>, 'Chi tiết khóa học'],
