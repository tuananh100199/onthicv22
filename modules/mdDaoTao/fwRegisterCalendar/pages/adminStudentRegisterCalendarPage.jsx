                    ...
                    <div className='tile-body'>
                        <div className='box_time_table row' >
                            ...
                            <div className='col-sm-10' >
                                ...
                                {currentLecturer && item && item._id ? <LecturerView key={key} official={false} courseId={item._id} lecturerId={currentLecturer && currentLecturer._id} filterOn={filterOn} filterType={filterType} list={list} calendar={calendar} lecturerName={currentLecturer && currentLecturer.lastname + ' ' + currentLecturer.firstname} /> : null}
                            </div>
                        </div>
                    </div>
                </div>),
