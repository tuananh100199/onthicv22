...
class CertificationPage extends AdminPage {
    ...
    componentDidMount() {
        T.ready('/user/license', () => {
            ...
            this.props.getCertificatePage(1, 50, {datSatHach:true});
        });
    }

    onSearch = ({ pageNumber, pageSize, searchText }, done) => {
        if (searchText == undefined) searchText = this.state.searchText;
        this.setState({ isSearching: true }, () => this.props.getCertificatePage(pageNumber, pageSize, { searchText,datSatHach:true }, (page) => {
        ...
        const table = renderTable({
            ...
            renderHead: () => (
                <tr>
                    ...
                    <th style={{ width: 'auto' }} nowrap='true'>Đã nhận</th>
                    <th style={{ width: 'auto' }} nowrap='true'>Ngày nhận bằng lái</th>
