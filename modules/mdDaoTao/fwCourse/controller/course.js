module.exports = (app) => {
    ...
    app.get('/user/hoc-vien/khoa-hoc/huong-dan-su-dung/:_id', app.permission.check('user:login'), app.templates.admin);
    ...
    app.get('/user/hoc-vien/khoa-hoc/:_id/cong-no/huong-dan', app.permission.check('user:login'), app.templates.admin);
