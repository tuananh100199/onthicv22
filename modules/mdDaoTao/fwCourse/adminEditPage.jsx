...
import AdminSubjectView from './pageView/adminSubjectVieww';
import AdminManagerView from './pageView/adminManagerVieww';
import AdminStudentView from './pageView/adminStudentVieww';
import AdminTeacherView from './pageView/adminTeacherVieww';
import AdminRepresentersView from './pageView/adminRepresentersVieww';
import AdminLearningProgressView from './pageView/adminLearningProgressVieww';
import LecturerStudentView from './pageView/lecturerStudentVieww';
import LecturerLearningProgressView from './pageView/lecturerLearningProgressVieww';
import LecturerRatingView from './pageView/lecturerRatingVieww';
import AdminAllChat from '../fwChat/adminAllChat';
import AdminPersonalChat from '../fwChat/adminPersonalChat';
import AdminFeedbackView from './pageView/adminFeedbackVieww';
...
class EditCoursePage extends AdminPage {
    ...
    render() {
        ...
        const lecturerTabs = [
            ...
            { title: 'Đánh giá bài học', component: this.state.courseType && this.props.course && this.props.course.item ? <LecturerRatingView permission={permission} courseType={this.state.courseType} courseId={courseId} /> : null },
