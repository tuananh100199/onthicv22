        ...
        return this.renderPage({
            ...
            content: (
                <div className='row user-course'>
                    ...
                    <PageIcon visible={isLecturer} to={`/user/course/${item._id}/lecturer/register-calendar`} icon='fa-calendar-plus-o' iconBackgroundColor='#8e24aa' text='Đăng ký lịch dạy' />
