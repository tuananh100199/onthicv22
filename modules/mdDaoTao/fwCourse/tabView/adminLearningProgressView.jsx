...
import { getLearingProgressByAdmin } from '../../fwCourse/redux';
import { AdminPage, renderTable, TableCell } from 'view/component/AdminPage';

class AdminStudentView extends AdminPage {
    state = {};
    componentDidMount() {
        this.props.getLearingProgressByAdmin(this.props.courseId, data => {
...
const mapActionsToProps = { getLearingProgressByAdmin };
