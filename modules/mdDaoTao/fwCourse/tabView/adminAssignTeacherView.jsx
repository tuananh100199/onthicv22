                                ...
                                <ol style={{ width: '100%', paddingLeft: 20, margin: 0 }}>
                                    {item.student.map((student, indexStudent) => (
                                        ...
                                        >
                                            ...
                                            {list[index].student[indexStudent].isHide && permission.write ? <i onClick={e => this.remove(e, item._id, student._id, indexStudent)} style={{ float: 'right', color: 'red' }} className='fa fa-user-times' /> : ''}
                                        </li>
                                    ))}
                                </ol> </> : 'Chưa có học viên'}
                        </ul>
