...
import { exportTN01, getCourse } from '../redux';
...
class AdminReportTN01Page extends AdminPage {
    ...
    exportTN01 = () => {
        ...
        if(courseId){
            this.props.exportTN01(courseId, (data) => {
            ...
            content: <>
                <div className='tile'>
                    <div className='row'>
                        ...
                        <FormTextBox ref={e => this.hoidong1 = e} className={'col-md-4'} label='Hội đồng' readOnly={false} />
                        ...
                        <FormTextBox ref={e => this.hoidong2 = e} className={'col-md-4'} label='Hội đồng' readOnly={false} />
                        ...
                        <FormTextBox ref={e => this.hoidong3 = e} className={'col-md-4'} label='Hội đồng' readOnly={false} />
                        ...
                        <FormTextBox ref={e => this.hoidong4 = e} className={'col-md-4'} label='Hội đồng' readOnly={false} />
                        <FormTextBox ref={e => this.numOfRegister = e} className={'col-md-6'} label='Số lượng học viên đăng ký' readOnly={false} />
                        <FormTextBox ref={e => this.numOfStudent = e} className={'col-md-6'} label='Số lượng học viên đạt yêu cầu' readOnly={false} />
                    </div>
                </div>
...
const mapActionsToProps = { getStudentPage, updateStudent, getCourseTypeAll, exportTN01, getCourse };
