...
import { exportTN05, getCourse } from '../redux';
...
class AdminReportTN05Page extends AdminPage {
    ...
    render() {
        ...
        return this.renderPage({
            ...
            title: 'Quyết định ban coi chấm thi (Phụ lục TN05)',
            breadcrumb: [<Link key={0} to='/user/course'>Khóa học</Link>,<Link key={1} to={'/user/course/' + this.state.courseId + '/report'}>Báo cáo</Link>,'Quyết định ban coi chấm thi (Phụ lục TN05)'],
            content: <>
                <div className='tile'>
                    <div className='row'>
...
const mapActionsToProps = { getStudentPage, updateStudent, getCourseTypeAll, exportTN05, getCourse };
