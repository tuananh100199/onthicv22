...
import { getCourse, updateStudentInfoInCourse, updateCourseRepresenterGroup, updateCourseRepresenterGroupStudent, exportRepresenterAndStudentToExcel } from '../redux';
...
class AdminRepresenterPage extends AdminPage {
    ...
    render() {
        ...
        return this.renderPage({
            ...
            breadcrumb: [<Link key={0} to='/user/course'>Khóa học</Link>, item._id ? <Link key={0} to={backRoute}>{item.name}</Link> : '', 'Gán GV'],
            content: (
                <div className='tile'>
                    <div className='tile-body row'>
                        ...
                        <div className='col-md-6'>
                            ...
                            <div style={{ borderWidth: 1, borderStyle: 'solid', borderColor: '#ddd', borderRadius: 5, padding: 12 }}>
                                ...
                                {representerGroups && representerGroups.length ?
...
const mapActionsToProps = { getCourse, updateStudentInfoInCourse, updateCourseRepresenterGroup, updateCourseRepresenterGroupStudent, updateStudent, exportRepresenterAndStudentToExcel };
export default connect(mapStateToProps, mapActionsToProps)(AdminRepresenterPage);