...
import AdminAllChat from 'modules/mdDaoTao/fwChat/adminAllChat';
import { AdminPage } from 'view/component/AdminPage';

export class AdminChatAllPage extends AdminPage {
    state = {};
    componentDidMount() {
        T.ready('/user/course', () => {
            const params = T.routeMatcher('/user/course/:_id/chat-all').parse(window.location.pathname);
            ...
            content: (
                <div className='tile'>
                    <div className='tile-body'>
                        {item && item._id ? <AdminAllChat courseId={item._id} /> : null}
                    </div>
                </div>),
            backRoute,
        });
...
export default connect(mapStateToProps, mapActionsToProps)(AdminChatAllPage);