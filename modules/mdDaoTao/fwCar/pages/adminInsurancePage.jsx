...
class CarPage extends AdminPage {
    ...
    componentDidMount() {
        ...
        condition = { ngayHetHanBaoHiem: dateCondition };
        ...
        const table = renderTable({
            ...
            renderHead: () => (
                <tr>
                    ...
                    <th style={{ width: '100%' }} nowrap='true'>Ngày hết hạn đóng bảo hiểm</th>
            ...
            renderRow: (item, index) => (
                <tr key={index}>
                    ...
                    <TableCell type='text' style={{ whiteSpace: 'nowrap' }} content={T.dateToText(item.ngayHetHanBaoHiem, 'dd/mm/yyyy')} />
                    <TableCell type='buttons' content={item} permission={permission} onEdit={'/user/car/insurance/' + item._id} />
                </tr >),
        });
