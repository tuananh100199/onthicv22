...
class HistoryCalendarPage extends AdminPage {
        ...
        const table = renderTable({
            ...
            renderRow: (item, index) => (
                <tr key={index}>
                    ...
                    <TableCell type='link' style={{ whiteSpace: 'nowrap' }} content={item.licensePlates} url={'/user/car/history-calendar/' + item._id} />
                    ...
                    <TableCell type='buttons' content={item} permission={permission} onEdit={'/user/car/history-calendar/' + item._id} />
                </tr >),
        });
...
export default connect(mapStateToProps, mapActionsToProps)(HistoryCalendarPage);
