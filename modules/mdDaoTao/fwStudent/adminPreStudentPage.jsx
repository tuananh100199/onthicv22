        ...
        const table = renderTable({
            ...
            renderRow: (item, index) => (
                <tr key={index}>
                    ...
                    <TableCell type='text' content={<label>{permissionUser.read ? <a href={`/user/member?user=${item.user && item.user._id}`}>{item.user && item.user.email}</a> : item.user && item.user.email}<br />{T.mobileDisplay(item.user && item.user.phoneNumber)}</label>} />
