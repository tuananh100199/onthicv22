    ...
    render = () => this.renderModal({
        ...
        buttons:
            <a className='btn btn-warning' href='#' onClick={e => {
                ...
                this.props.addStudentPayment(studentId, {fee: this.props.fee, user: this.props.userId}, () => {
                    this.hide();
    ...
    render() {
        ...
        return this.renderPage({
            ...
            content: <>
                ...
                <PaymentInfoModal fee={this.state.soTienDong} name={name} userId={userId} courseFeeName={student && student.courseFee ? student.courseFee.name : ''} accounts={this.state.accounts} readOnly={true} addStudentPayment={this.props.addStudentPayment} studentId={studentId} ref={e => this.modal = e} />
            </>,
