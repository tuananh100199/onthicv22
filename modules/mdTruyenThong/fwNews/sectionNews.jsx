...
class SectionNews extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            //                                     key={index}>
            //                                     <div className='team_item d-flex flex-column align-items-center justify-content'>
            ...
            //                     {/* <div class="owl-carousel owl-theme news_carousel">
            //                         {newsFeed.map((item, index) => (
            //                                 <div className={'team_col carousel-item' + (index == 0 ? ' active' : '')}
            //                                     key={index}>
            //                                     <div className='team_item d-flex flex-column align-items-center justify-content'>
            ...
            <div className='services news' style={{ backgroundColor: 'aliceblue' }}>
                ...
                <div>{this.state.viewport == 'big' ?
                    ...
                    <div className='news_mobile'>
                            ...
                            <div className="owl-carousel owl-theme news_carousel">
                                {newsFeed.map((item, index) => (
                                        <div className={'team_col carousel-item' + (index == 0 ? ' active' : '')}
                                            key={index}>
                                            <div className='team_item d-flex flex-column align-items-center justify-content'>
